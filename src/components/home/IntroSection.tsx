      ...
      <div className="flex flex-col justify-start items-start gap-[40px] w-[720px] max-w-[720px]">
        ...
        <div className="flex flex-col items-start gap-5 self-stretch">
          <div className="px-3 py-1 bg-red-700/60 inline-flex justify-center items-center gap-2.5">
            <div className="text-white font-pretendard text-[32px] font-semibold leading-[120%] tracking-[-0.64px]">
              서강대학교 멋쟁이사자처럼은
            </div>
          </div>
          <div className="self-stretch text-black/80 font-pretendard text-[20px] font-semibold leading-[140%]">
            기초부터 심화까지, 아이디어를 실제 서비스로 만들어보는 경험을 하는
            IT 창업 동아리입니다.이 과정에서 대면 교육 세션과 해커톤, 데모데이
            등 다양한 활동을 통해 함께 배우고 도전하며 성장합니다. 이러한 활동의
